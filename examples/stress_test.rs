...
fn main() {
    ...
    let oop_range = "99-22,ATs-A2s,AQo-ATo,KJs-K2s,KJo-KTo,Q4s+,QTo+,J5s+,JTo,T5s+,T8o+,95s+,97o+,86s+,87o,76,65o,54o";
    let ip_range = "55+,A2s+,ATo+,K7s+,KJo+,Q9s+,QJo,J9s+,T9s";
    ...
    let bet_sizes = BetSizeOptions::try_from(("33%, 66%, 120%, a", "2.5x, 4x, a")).unwrap();
